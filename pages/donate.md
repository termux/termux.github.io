...
- Yaksh Bariya ([@thunder-coding](https://github.com/thunder-coding)) maintains `nodejs`, and often updates critical dependencies in main repo. Mostly packaging work and other chore tasks. [Visit for Yaksh Bariya's website for more information](https://codingthunder.me/sponsor/)
...
*Note for [@termux](https://github.com/termux) maintainers: Feel free to add/update/delete your donation links on site source.*
